...
public class ChatController {
    ...
    public ResponseVO saveWorkSpace(@RequestBody ChatWorkSpace chatWorkSpace){return chatBL.saveWorkSpace(chatWorkSpace);}

    @RequestMapping(value = "/getChattingRecords",method = RequestMethod.POST)
    public ResponseVO getChattingRecords(@RequestBody List<Integer> userIds){return chatBL.getChattingRecords(userIds);}

    @RequestMapping(value = "/getWorkSpace/{userId}",method = RequestMethod.GET)
    public ResponseVO getWorkSpace(@PathVariable int userId){return chatBL.getWorkSpace(userId);}


    @RequestMapping(value = "/readMessages",method = RequestMethod.POST)
    public ResponseVO readMessages(UserIdAndMessageIdsForm userIdAndMessageIdsForm){return chatBL.readMessages(userIdAndMessageIdsForm);}
